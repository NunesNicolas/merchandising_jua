  ...
  <div>
    ...
    "> 
          ...
          <table class="" style="text-align: center; color:#858585; width:100%">
            ...
            <th class="detalhesBt">
            <button id="open-modal">Detalhes <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-text" viewBox="0 0 16 16">
    ...
    <!-- --------------------------MODAL GERAL--------------------- -->
                  ...
                  <!-- --------------------------MODAL BODY--------------------- -->
                    <div class="modal-body">
                      <p>lorem lore lorem</p>
                      <h1>receba</h1>
                      <p>lorem lore lorem Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt repellat numquam, ex ipsa expedita omnis magnam distinctio veniam quod ipsum doloribus ab obcaecati iure voluptate sint odit repellendus quasi possimus!</p>
                      <p>lorem lore lorem</p>
                      <p>lorem lore lorem</p>
                      <p>lorem lore lorem</p>
                    </div>
