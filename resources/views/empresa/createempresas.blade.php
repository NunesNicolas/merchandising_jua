        ...
        <hr>
            ...
            @csrf
                ...
                <div class ="form-group">
                    ...
                    <input type="text" class ="form-control" name="cnpj" placeholder="Digite um CNPJ">
                </div>
                <br>
                <div class ="form-group">
                    <label for="latitude">Latitude:</label>
                    <input type="text" class ="form-control" name="latitude" placeholder="Digite uma latitude">
                </div>
                <br>
                <div class ="form-group">
                    <label for="longitude">Longitude:</label>
                    <input type="text" class ="form-control" name="longitude" placeholder="Digite uma longitude">
                </div>
                <br>
                <div class ="form-group">
