  ...
  <div class="d-flex" style="width: 100%; height: 4vh; justify-content:end; padding:35px">
    ...
    ">
      ...
      <div class="d-flex" style="
          ...
          <div style="width: 100vh; height:50vh; background:#ffffff; border-radius:10px; margin-right: 30px; border:darkgray solid 1px; text-align: left;">
          ...
          <div style="width: 100vh; height:50vh; background:#ffffff; border-radius:10px; border:darkgray solid 1.2px; text-align:left">
            <ul class="list" style="list-style-type:none; padding:5px">
              <li class="list-item">  <p style="text-align:initial"> ROTEIRO DO PROMOTOR <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2C9AFF" class="bi bi-pencil-square" viewBox="0 0 16 16">
                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-sm">
                      CLIENTE
                      <p style="font-size:11px; font-weight:normal ;">Cariri</p>
                    </div>
                    <div class="col-sm">
                      ÚLTIMA VISITA
                    </div>
