    ...
    <div class="page">
        ...
        <div class="conteiner mt-4  ml-5 mr-5 " style="text-align: justify;">
            ...
            <form action="http://127.0.0.1:8000/promotores" method="POST" @submit.prevent="savePromotor" novalidate>
                <input type="hidden" name="_token" value="cgr3ItMlDgvqpEnKYPY9aBZe2ipUT7grzJG1UV54" autocomplete="off">
                <div class="form-group">
                    <label for="nome">Nome:</label>
                    <input type="text" class="form-control " name="nome" v-model="promotor.nome"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="email" v-model="promotor.email"
                        placeholder="digite um Email">
                </div>
                <br>
                <div class="form-group">
                    <label for="senha">Senha:</label>
                    <input type="text" class="form-control " name="senha" v-model="promotor.senha"
                        placeholder="digite sua senha">
                </div>
                <br>
                <div class="form-group">
                    <label for="telefone">Telefone:</label>
                    <input type="text" class="form-control " name="telefone" v-model="promotor.telefone"
                        placeholder="digite um Telefone">
                </div>
                <br>
                <div class="form-group">
                    <input type="submit" nome="submit" class="btn btn-lg btn-primary"
                        style="background-color: #2c9aff; border: none">
                </div>
