        ...
        <form action="http://127.0.0.1:8000/produtos" method="POST" @submit.prevent="saveProduto" novalidate>
            ...
            <table class="">
                <div class="form-check" >
                    <input id="weight500" name="weight500" value="500" class="form-check-input" type="checkbox" @change="updateWeights(500, $event)">
                ...
                <div class="form-check">
                    <input id="weight1000" name="weight1000" value="1000" class="form-check-input" type="checkbox"  @change="updateWeights(1000, $event)">
                ...
                <div class="form-check">
                    <input id="weight5000" name="weight5000" value="5000" class="form-check-input" type="checkbox"  @change="updateWeights(5000, $event)">
