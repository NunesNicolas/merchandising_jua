...
<template>
    <div class="d-flex flex-wrap" style="width: 100%; padding: 3vh 3vw;">
        ...
        " @submit.prevent="saveCompetitor" novalidate>   
                ...
                <input type="text" style="height: 6vh;" class="form-control" name="nome" v-model="competitors.nome" placeholder="Digite um Nome">
                <label class="" for="nomedamarca" style="margin-top: 3vh;">Nome da produtora</label>
                <input type="text" style="height: 6vh;" class="form-control" name="brand" v-model="competitors.brand" placeholder="Digite o nome da produtora ">
