...
<template> 
  ...
  <div class="d-flex" style="width: 100%; height: 4vh; justify-content:end; padding:35px">
    ...
    height: 30px;
    width: 70px;
    "> <p class="mt-1" style="margin-top: 2px">VOLTAR</p> </a>
  </div>
        ...
        <!-- </b-button> -->
                   ...
                   <div class="d-flex" style="width: 100%">
                    ...
                    <div style="display: flex; width: 68vw; height: 30vh; flex-wrap: wrap; align-items: center; justify-content: space-between; padding: 1vh;">
                      ...
                      <label style="width: 48%; text-align: start; color:#858585; font-weight: bold;">Quantidade do concorrente:   </label>
                  ...
                  <div class="divFooter" style="width: 100%">
                    <div class="btnPeso">
                      ...
                      <router-link :to="{name: 'InfoProdutos', params: {id: button500}}">
                        <a type="button" class="peso" :class="{ 'botao-ativo': paginaAtual == '500' }"  name="500" ac value="" style="border-bottom: solid;border-radius: 0vh 0vh 0vh 1vh;" href="">500g</a>
                      </router-link>
                        
                      <router-link :to="{name: 'InfoProdutos', params: {id: button1000}}">
                        <a type="button"  class="peso" :class="{ 'botao-ativo': paginaAtual == '1000' }"  name="1000" style="border-bottom: solid" value="" href="">1kg</a>
                      </router-link>
                      
                      <router-link :to="{name: 'InfoProdutos', params: {id: button5000}}">
                      <a type="button"  class="peso" :class="{ 'botao-ativo': paginaAtual == '5000' }" name="5000" style="border-bottom: solid" value="" href="">5kg</a>
                      </router-link>
                        
        
                    </div>
                      
                    <div class="btnPeso2 mb-3" style="display:flex; flex-wrap: wrap; justify-content: end; align-items: center; padding-right: 1vw">
      ...
      <div id="contentCompetitors" v-if="temCompetitors">
        <router-link :to="{ name: 'createCompetitors', params:{id: this.id}}"> 
          <div class="d-flex flex-wrap" style="width:100%; align-items:start; padding:1%">
              <a href="" class="btn btn-primary" style="color:#ffffff; font-weight: bold; border-radius:15px; align-items:left; padding: 0.5vh 1vw; ">ADICIONAR CONCORRENTE
              </a>
          </div>
        </router-link>
      ...
      <div v-else="temCompetitors">
        <router-link :to="{ name: 'createCompetitors', params:{id: this.id}}">
          <div style="width:100%; text-align:justify; align-items:start; padding:1%">
            <a href="" class="btn btn-primary" style="color:#ffffff; width: 20%; height:33px; font-weight: bold; border-radius:15px; align-items:left"> <p class="mt-1">ADICIONAR CONCORRENTE</p>
            </a>
          </div>
        </router-link>
        <h2 style="font-weight:bold; text-align:justify; color:#808080; font-size:20px;"> SEM PRODUTOS CONCORRENTES CADASTRADOS</h2>
      </div>
    </div>
...
.inputFachada{
    height: 7vh; border:none solid #662222; background-color: #e7e7e7; color: #808080; border-radius: 1vh; padding: 1vh; text-align:justify;
...
label{
  ...
  .modalEditar input, select, option{
    width: 27vw;
    height: 6vh;
    font-size: 2.2vh;
  } 
